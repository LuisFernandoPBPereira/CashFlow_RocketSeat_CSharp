...
namespace CashFlow.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// </summary>
        public static string AMOUNT_MUST_BE_GREATER_THAN_ZERO_ERROR {
            get {
                return ResourceManager.GetString("AMOUNT_MUST_BE_GREATER_THAN_ZERO_ERROR", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Consulta uma cadeia de caracteres localizada semelhante a The date can&apos;t be in the future.
        /// </summary>
        public static string EXPENSES_CANT_BE_IN_THE_FUTURE_ERROR {
            get {
                return ResourceManager.GetString("EXPENSES_CANT_BE_IN_THE_FUTURE_ERROR", resourceCulture);
            }
        }
